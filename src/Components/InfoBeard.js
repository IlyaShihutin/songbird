                    ...
                    <div className="info">
                        ...
                        <div className="info-name-sound">
                            ...
                            <div className="info-sound">
                                <AudioPlayer
                                    src={beard[this.props.category][this.props.beard].sound} customAdditionalControls={[]} showJumpControls={false} customVolumeControls={[]} autoPlayAfterSrcChange={false}
                                />
                            </div>
                        </div>
                    </div>
