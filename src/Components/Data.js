const beard = [
    [
        {
            ...
            img: "https://github.com/IlyaShihutin/songbird/blob/songbird/src/Components/source/img/1.jpg?raw=true",
            sound: "https://github.com/IlyaShihutin/songbird/blob/songbird/src/Components/source/sound/1-MichaelJackson.mp3?raw=true",
        ...
        },
        {
            ...
            text: "В 2020 году Айлиш стала триумфатором музыкальной премии Грэмми, выиграв все четыре основные номинации: Песня года, Альбом года, Запись года и Лучший новый исполнитель, а также победив в номинации Лучший вокальный поп-альбом. В результате она стала первым с 1981 года исполнителем (и лишь вторым в истории после Кристофера Кросса), получившим все четыре главных награды года."
        },
        {
            nameRu: "Бритни Спирс",
            nameEn: "Britney Spears",
            img: "https://github.com/IlyaShihutin/songbird/blob/songbird/src/Components/source/img/5.jpg?raw=true",
            sound: "https://github.com/IlyaShihutin/songbird/blob/songbird/src/Components/source/sound/1-BritneySpears.mp3?raw=true",
            text: "Её дебютный альбом …Baby One More Time сделал её всемирно популярной, а одноимённый сингл возглавил чарт Billboard Hot 100. Первый альбом Бритни содержал пять успешных хитов. Успешный дебют певицы в музыке породил большой общественный резонанс: так, The Daily Yomiuri назвала её «самым одарённым несовершеннолетним поп-идолом последних лет», а по мнению Rolling Stone, «Бритни Спирс — классический стереотип подростковой королевы рок-н-ролла, ангельский ребёнок, который просто должен быть на сцене»"
        },
        {
            nameRu: "Дима Билан",
            nameEn: "Dima Bilan",
            img: "https://github.com/IlyaShihutin/songbird/blob/songbird/src/Components/source/img/6.jpg?raw=true",
            sound: "https://github.com/IlyaShihutin/songbird/blob/songbird/src/Components/source/sound/1-Dima.mp3?raw=true",
            text: "Представлял Россию на конкурсе песни «Евровидение» дважды: в 2006 году с песней «Never Let You Go», заняв второе место, и в 2008 году с песней «Believe», заняв первое место и став первым исполнителем из России, победившим на «Евровидении»."
        }
    ],
    [
        {
            ...
            text: "армяно-американская рок-группа, образованная в 1992 году в Лос-Анджелесе Сержем Танкяном и Дароном Малакяном под названием Soil, а в 1995 принявшая нынешнее название. Все участники группы имеют армянское происхождение. В период с 1998 по 2005 год группа выпустила пять студийных альбомов, каждый из которых стал платиновым. Было продано более 40 миллионов копий альбомов по всему миру."
        },
        {
            nameRu: "AC/DC",
            nameEn: "AC/DC",
            img: "https://github.com/IlyaShihutin/songbird/blob/songbird/src/Components/source/img/8.jpg?raw=true",
            sound: "https://github.com/IlyaShihutin/songbird/blob/songbird/src/Components/source/sound/2-AC_DC.mp3?raw=true",
        ...
        },
        {
            ...
            text: "финская англоязычная хард-рок-группа. Основана в 1992 году Mr. Lordi. Группа знаменита тем, что выступает в масках и костюмах монстров и исполняет песни на тему ужасов и тяжёлой музыки. Lordi выиграли конкурс песни «Евровидение» в 2006 году."
        },
        {
            nameRu: "Linkin Park",
            nameEn: "Linkin Park",
            img: "https://github.com/IlyaShihutin/songbird/blob/songbird/src/Components/source/img/10.jpg?raw=true",
            sound: "https://github.com/IlyaShihutin/songbird/blob/songbird/src/Components/source/sound/2-linkin.mp3?raw=true",
            text: "Существуя с 2000 года под названием Linkin Park, группа была шесть раз номинирована и два раза удостоилась награды «Грэмми». Группа обрела успех благодаря дебютному альбому 2000 года под названием Hybrid Theory, проданному тиражом более чем в 30 миллионов экземпляров"
        },
        {
            nameRu: "Кино",
            nameEn: "Кино",
            img: "https://github.com/IlyaShihutin/songbird/blob/songbird/src/Components/source/img/11.jpg?raw=true",
            sound: "https://github.com/IlyaShihutin/songbird/blob/songbird/src/Components/source/sound/2-kino.mp3?raw=true",
    ...
    [
        {
            nameRu: "Disturbed",
            nameEn: "Disturbed",
            img: "https://github.com/IlyaShihutin/songbird/blob/songbird/src/Components/source/img/13.jpg?raw=true",
            sound: "https://github.com/IlyaShihutin/songbird/blob/songbird/src/Components/source/sound/3-Disturbed.mp3?raw=true",
            text: "С момента формирования группы они продали около 35 миллионов копий альбомов во всем мире, выпустили семь студийных альбомов и один концертный, став одной из самых успешных рок-групп за последние годы."
        },
        {
            nameRu: "Slipknot",
            nameEn: "Slipknot",
            img: "https://github.com/IlyaShihutin/songbird/blob/songbird/src/Components/source/img/14.jpg?raw=true",
            sound: "https://github.com/IlyaShihutin/songbird/blob/songbird/src/Components/source/sound/3-Slipknot.mp3?raw=true",
            text: "В 2006 году группа получила свою единственную на сегодняшний день премию «Грэмми». Коллектив известен тем, что его участники на концертах, фотосессиях и интервью носят маски и специальные комбинезоны. Маски видоизменяются с выходом нового альбома. На данный момент группа выпустила шесть студийных альбомов, включая новый We Are Not Your Kind."
        },
        {
            nameRu: "Oomph!",
            nameEn: "Oomph!",
            img: "https://github.com/IlyaShihutin/songbird/blob/songbird/src/Components/source/img/15.jpg?raw=true",
            sound: "https://github.com/IlyaShihutin/songbird/blob/songbird/src/Components/source/sound/3-OOMPH!.mp3?raw=true",
    ...
    [
        ...
        },
        {
            ...
            text: "Снуп известен своей манерой исполнения — ленивая, подчёркнуто спокойная, с растянутыми словами и ритмичной лирикой. Создаёт биты под псевдонимом Niggaracci. Множество совместных работ с музыкантами различных жанров[24]. Помимо студийных альбомов, есть ряд микстейпов."
        },
        {
            nameRu: "Каста",
            nameEn: "Каста",
            img: "https://github.com/IlyaShihutin/songbird/blob/songbird/src/Components/source/img/22.jpg?raw=true",
            sound: "https://github.com/IlyaShihutin/songbird/blob/songbird/src/Components/source/sound/4-kasta.mp3?raw=true",
    ...
    [
        ...
        },
        {
            ...
            text: "20 октября 2011 года по результатам авторитетного международного рейтинга DJ Magazine Дэвид Гетта стал диджеем номер один.В 2019 году занял 3 место в списке лучших диджеев мира по версии DJ Magazine."
        }
    ],
    [
        {
        ...
        },
        {
            ...
            text: "Как дирижёр дебютировал в 1951 году в Литовском театре оперы и балета (опера С. Монюшко «Галька»). С 1947 года — концертмейстер Оперной студии Вильнюсской консерватории. С 1951 — дирижёр Литовского театра оперы и балета. "
        }
    ],
    [
        {
            nameRu: "0",
            nameEn: "",
            picture: "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQ2g3T3kPTratqjBIs_v7KCFQiweTjH76sAAA&usqp=CAU",
            sound: "",
            text: ""
        }
    ],
    ["Pop","Rock","Metal","Rap","Electro","Classic" ]
]
